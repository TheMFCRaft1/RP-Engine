...
public class SmartphoneUIScreen extends ContainerScreen<SmartphoneUIMenu> {
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		imagebutton_warningsign_2 = new ImageButton(this.guiLeft + 9, this.guiTop + 28, 50, 32, 0, 0, 32, new ResourceLocation("rp_engine:textures/screens/atlas/imagebutton_warningsign_2.png"), 50, 64, e -> {
		});
