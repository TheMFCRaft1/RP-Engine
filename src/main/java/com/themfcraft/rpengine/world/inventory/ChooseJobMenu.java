...
public class ChooseJobMenu extends Container implements Supplier<Map<Integer, Slot>> {
	...
	public ChooseJobMenu(int id, PlayerInventory inv, PacketBuffer extraData) {
		super(RpEngineModMenus.CHOOSE_JOB.get(), id);
