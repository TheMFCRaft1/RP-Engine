...
public class SetupGUIMenu extends Container implements Supplier<Map<Integer, Slot>> {
	...
	public SetupGUIMenu(int id, PlayerInventory inv, PacketBuffer extraData) {
		super(RpEngineModMenus.SETUP_GUI.get(), id);
