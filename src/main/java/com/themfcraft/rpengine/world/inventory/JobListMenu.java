...
public class JobListMenu extends Container implements Supplier<Map<Integer, Slot>> {
	...
	public JobListMenu(int id, PlayerInventory inv, PacketBuffer extraData) {
		super(RpEngineModMenus.JOB_LIST.get(), id);
