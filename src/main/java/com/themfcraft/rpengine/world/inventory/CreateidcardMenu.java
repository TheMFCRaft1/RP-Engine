...
public class CreateidcardMenu extends Container implements Supplier<Map<Integer, Slot>> {
	...
	public CreateidcardMenu(int id, PlayerInventory inv, PacketBuffer extraData) {
		super(RpEngineModMenus.CREATEIDCARD.get(), id);
