...
public class SmartphoneUIEmergencyMenu extends Container implements Supplier<Map<Integer, Slot>> {
	...
	public SmartphoneUIEmergencyMenu(int id, PlayerInventory inv, PacketBuffer extraData) {
		super(RpEngineModMenus.SMARTPHONE_UI_EMERGENCY.get(), id);
